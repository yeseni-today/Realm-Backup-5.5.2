...
// MARK: - SwiftSyncTestCase
class SwiftSyncTestCase: RLMSyncTestCase {

  var task: Process?

  let authURL: URL = .init(string: "http://127.0.0.1:9080")!
  let slowConnectAuthURL: URL = .init(string: "http://127.0.0.1:9083")!
  let realmURL: URL = .init(string: "realm://127.0.0.1:9080/~/testBasicSync")!
