...
func gsub(pattern: String, template: String, string: String, error: NSErrorPointer = nil) -> String? {
...
func cast<U, V>(_ value: U, to: V.Type) -> V {
  if let v = value as? V {
    return v
  }
...
protocol CustomObjectiveCBridgeable {
  static func bridging(objCValue: Any) -> Self
  var objCValue: Any { get }
}

// MARK: - Float + CustomObjectiveCBridgeable
...
// MARK: - Int8 + CustomObjectiveCBridgeable
...
// MARK: - Int16 + CustomObjectiveCBridgeable
...
// MARK: - Int32 + CustomObjectiveCBridgeable
...
// MARK: - Int64 + CustomObjectiveCBridgeable
...
// MARK: - Optional + CustomObjectiveCBridgeable
...
protocol AssistedObjectiveCBridgeable {
