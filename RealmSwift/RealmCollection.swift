...
// MARK: - Optional + RealmCollectionValue
...
// MARK: - Int + RealmCollectionValue
extension Int: RealmCollectionValue {}

// MARK: - Int8 + RealmCollectionValue
extension Int8: RealmCollectionValue {}

// MARK: - Int16 + RealmCollectionValue
extension Int16: RealmCollectionValue {}

// MARK: - Int32 + RealmCollectionValue
extension Int32: RealmCollectionValue {}

// MARK: - Int64 + RealmCollectionValue
extension Int64: RealmCollectionValue {}

// MARK: - Float + RealmCollectionValue
...
// MARK: - Double + RealmCollectionValue
...
// MARK: - Bool + RealmCollectionValue
...
// MARK: - String + RealmCollectionValue
...
// MARK: - Date + RealmCollectionValue
...
// MARK: - Data + RealmCollectionValue
...
// MARK: - _RealmCollectionEnumerator
/// :nodoc:
...
// MARK: - RealmCollectionBase
/// :nodoc:
public protocol RealmCollectionBase: RandomAccessCollection, LazyCollectionProtocol, CustomStringConvertible,
  ThreadConfined where Element: RealmCollectionValue
{
...
private class _AnyRealmCollectionBase<T: RealmCollectionValue>: AssistedObjectiveCBridgeable {
  ...
  func min<V: MinMaxType>(ofProperty property: String) -> V? { fatalError() }
  func max<V: MinMaxType>(ofProperty property: String) -> V? { fatalError() }
  func sum<V: AddableType>(ofProperty property: String) -> V { fatalError() }
...
private final class _AnyRealmCollection<C: RealmCollection>: _AnyRealmCollectionBase<C.Element> {
  ...
  override var bridged: (objectiveCValue: Any, metadata: Any?) {
    (base as! AssistedObjectiveCBridgeable).bridged
  }
...
// MARK: - AnyRealmCollectionBridgingMetadata
...
// MARK: - AnyRealmCollection + AssistedObjectiveCBridgeable
...
protocol ObservableCollection: RealmCollection {
...
// MARK: - List + ObservableCollection
extension List: ObservableCollection {
  typealias BackingObjcCollection = RLMArray<AnyObject>
  func isSameObjcCollection(_ rlmArray: BackingObjcCollection) -> Bool {
    return _rlmArray === rlmArray
  }
}

// MARK: - Results + ObservableCollection
extension Results: ObservableCollection {
  typealias BackingObjcCollection = RLMResults<AnyObject>
  func isSameObjcCollection(_ objc: RLMResults<AnyObject>) -> Bool {
    return objc === rlmResults
  }
}

// MARK: - LinkingObjects + ObservableCollection
