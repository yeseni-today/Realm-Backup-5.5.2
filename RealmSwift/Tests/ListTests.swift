...
class ListTests: TestCase {
  ...
  func testPopulateEmptyArray() {
    ...
    for obj in array {
      XCTAssertTrue(!obj.description.utf16.isEmpty, "Object should have description")
    }
  }
