...
// MARK: - OptionalMinMaxPrimitiveListTests
...
// MARK: - AddablePrimitiveListTests
...
// MARK: - OptionalAddablePrimitiveListTests
...
// MARK: - SortablePrimitiveListTests
...
// MARK: - OptionalSortablePrimitiveListTests
class OptionalSortablePrimitiveListTests<O: ObjectFactory, V: ValueFactory>: PrimitiveListTestsBase<O, V> where V.W: Comparable {
  func testSorted() {
    ...
    let values2 = unsafeBitCast(values!, to: [V.W?].self)
...
// MARK: - UnmanagedPrimitiveListTests
...
// MARK: - ManagedPrimitiveListTests
