...
// MARK: - ResultsWithCustomInitializerTests
...
// MARK: - ResultsFromTableViewTests
...
// MARK: - ListRealmCollectionTypeTests
class ListRealmCollectionTypeTests: RealmCollectionTypeTests {
  ...
  override func testDescription() {
    ...
    assertMatches(
      collection.description,
      "List<CTTNullableStringObjectWithLink> <0x[0-9a-f]+> \\(\n\t\\[0\\] CTTNullableStringObjectWithLink \\{\n\t\tstringCol = 1;\n\t\tlinkCol = \\(null\\);\n\t\\},\n\t\\[1\\] CTTNullableStringObjectWithLink \\{\n\t\tstringCol = 2;\n\t\tlinkCol = \\(null\\);\n\t\\}\n\\)"
    )
  }
...
// MARK: - ListUnmanagedRealmCollectionTypeTests
...
// MARK: - ListNewlyAddedRealmCollectionTypeTests
...
// MARK: - ListNewlyCreatedRealmCollectionTypeTests
...
// MARK: - ListRetrievedRealmCollectionTypeTests
...
// MARK: - LinkingObjectsCollectionTypeTests
class LinkingObjectsCollectionTypeTests: RealmCollectionTypeTests {
  ...
  override func testDescription() {
    ...
    assertMatches(
      collection.description,
      "LinkingObjects<CTTNullableStringObjectWithLink> <0x[0-9a-f]+> \\(\n\t\\[0\\] CTTNullableStringObjectWithLink \\{\n\t\tstringCol = 1;\n\t\tlinkCol = CTTLinkTarget \\{\n\t\t\tid = 0;\n\t\t\\};\n\t\\},\n\t\\[1\\] CTTNullableStringObjectWithLink \\{\n\t\tstringCol = 2;\n\t\tlinkCol = CTTLinkTarget \\{\n\t\t\tid = 0;\n\t\t\\};\n\t\\}\n\\)"
    )
  }
