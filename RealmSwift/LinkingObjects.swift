...
public struct LinkingObjects<Element: Object> {
  ...
  var rlmResults: RLMResults<AnyObject> {
...
extension LinkingObjects: AssistedObjectiveCBridgeable {
  static func bridging(from objectiveCValue: Any, with metadata: Any?) -> LinkingObjects {
  ...
  var bridged: (objectiveCValue: Any, metadata: Any?) {
    (objectiveCValue: handle!.results, metadata: nil)
  }
}
