...
public extension Realm {
  ...
  struct Configuration {
    ...
    var disableFormatUpgrade: Bool = false
    ...
    static func fromRLMRealmConfiguration(_ rlmConfiguration: RLMRealmConfiguration) -> Configuration {
...
// MARK: - Realm.Configuration + CustomStringConvertible
